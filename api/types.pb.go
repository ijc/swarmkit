...
func (PortConfig_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26, 0} }
...
func (PortConfig_PublishMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{26, 1}
}
...
func (IssuanceStatus_State) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31, 0} }
...
type ContainerNetworkStatus struct {
	...
	// Interface is the device name as seen within the container
	Interface string `protobuf:"bytes,2,opt,name=interface,proto3" json:"interface,omitempty"`
	// Types that are valid to be assigned to Address:
	//	*ContainerNetworkStatus_IP
	//	*ContainerNetworkStatus_Error
	Address isContainerNetworkStatus_Address `protobuf_oneof:"address"`
}

func (m *ContainerNetworkStatus) Reset()                    { *m = ContainerNetworkStatus{} }
func (*ContainerNetworkStatus) ProtoMessage()               {}
func (*ContainerNetworkStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{20} }

type isContainerNetworkStatus_Address interface {
	isContainerNetworkStatus_Address()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ContainerNetworkStatus_IP struct {
	IP string `protobuf:"bytes,3,opt,name=ip,proto3,oneof"`
}
type ContainerNetworkStatus_Error struct {
	Error string `protobuf:"bytes,4,opt,name=error,proto3,oneof"`
}

func (*ContainerNetworkStatus_IP) isContainerNetworkStatus_Address()    {}
func (*ContainerNetworkStatus_Error) isContainerNetworkStatus_Address() {}

func (m *ContainerNetworkStatus) GetAddress() isContainerNetworkStatus_Address {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ContainerNetworkStatus) GetIP() string {
	if x, ok := m.GetAddress().(*ContainerNetworkStatus_IP); ok {
		return x.IP
	}
	return ""
}

func (m *ContainerNetworkStatus) GetError() string {
	if x, ok := m.GetAddress().(*ContainerNetworkStatus_Error); ok {
		return x.Error
	}
	return ""
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ContainerNetworkStatus) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ContainerNetworkStatus_OneofMarshaler, _ContainerNetworkStatus_OneofUnmarshaler, _ContainerNetworkStatus_OneofSizer, []interface{}{
		(*ContainerNetworkStatus_IP)(nil),
		(*ContainerNetworkStatus_Error)(nil),
	}
}

func _ContainerNetworkStatus_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ContainerNetworkStatus)
	// address
	switch x := m.Address.(type) {
	case *ContainerNetworkStatus_IP:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.IP)
	case *ContainerNetworkStatus_Error:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.Error)
	case nil:
	default:
		return fmt.Errorf("ContainerNetworkStatus.Address has unexpected type %T", x)
	}
	return nil
}

func _ContainerNetworkStatus_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ContainerNetworkStatus)
	switch tag {
	case 3: // address.ip
		if wire != proto.WireBytes {
		...
		m.Address = &ContainerNetworkStatus_IP{x}
		return true, err
	case 4: // address.error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Address = &ContainerNetworkStatus_Error{x}
		return true, err
	default:
		return false, nil
	}
...
func _ContainerNetworkStatus_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ContainerNetworkStatus)
	// address
	switch x := m.Address.(type) {
	case *ContainerNetworkStatus_IP:
...
type ContainerStatus struct {
	...
	Networks    []*ContainerNetworkStatus `protobuf:"bytes,4,rep,name=networks" json:"networks,omitempty"`
}

func (m *ContainerStatus) Reset()                    { *m = ContainerStatus{} }
func (*ContainerStatus) ProtoMessage()               {}
func (*ContainerStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{21} }
...
func (*PortStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22} }
...
func (*TaskStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }
...
func (*NetworkAttachmentConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{24} }
...
func (*IPAMConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }
...
func (*PortConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26} }
...
func (*Driver) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{27} }
...
func (*IPAMOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{28} }
...
func (*Peer) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{29} }
...
func (*WeightedPeer) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{30} }
...
func (*IssuanceStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }
...
func (*AcceptancePolicy) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func (*AcceptancePolicy_RoleAdmissionPolicy_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{32, 0, 0}
}
...
func (*ExternalCA) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{33} }
...
func (*CAConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (*OrchestrationConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func (*TaskDefaults) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (*DispatcherConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{37} }
...
func (*RaftConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{38} }
...
func (*EncryptionConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }
...
func (*SpreadOver) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{40} }
...
func (*PlacementPreference) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{41} }
...
func (*Placement) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{42} }
...
func (*JoinTokens) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{43} }
...
func (*RootCA) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{44} }
...
func (*Certificate) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{45} }
...
func (*EncryptionKey) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{46} }
...
func (*ManagerStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{47} }
...
func (*FileTarget) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{48} }
...
func init() {
	...
	proto.RegisterType((*ContainerNetworkStatus)(nil), "docker.swarmkit.v1.ContainerNetworkStatus")
...
func (m *ContainerNetworkStatus) Copy() *ContainerNetworkStatus {
	if m == nil {
		return nil
	}
	o := &ContainerNetworkStatus{}
	o.CopyFrom(m)
	return o
}

func (m *ContainerNetworkStatus) CopyFrom(src interface{}) {

	o := src.(*ContainerNetworkStatus)
	*m = *o
	if o.Address != nil {
		switch o.Address.(type) {
		case *ContainerNetworkStatus_IP:
			v := ContainerNetworkStatus_IP{
				IP: o.GetIP(),
			}
			m.Address = &v
		case *ContainerNetworkStatus_Error:
			v := ContainerNetworkStatus_Error{
				Error: o.GetError(),
			}
			m.Address = &v
		}
...
func (m *ContainerStatus) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.Networks != nil {
		m.Networks = make([]*ContainerNetworkStatus, len(o.Networks))
		for i := range m.Networks {
			m.Networks[i] = &ContainerNetworkStatus{}
...
func (m *ContainerNetworkStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ContainerNetworkStatus) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Address != nil {
		nn20, err := m.Address.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn20
...
func (m *ContainerNetworkStatus_IP) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x1a
	i++
...
func (m *ContainerNetworkStatus_Error) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x22
	i++
...
func (m *TaskStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RuntimeStatus != nil {
		nn22, err := m.RuntimeStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn22
	...
	if m.PortStatus != nil {
		...
		n23, err := m.PortStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *ContainerNetworkStatus) Size() (n int) {
	var l int
	_ = l
	l = len(m.Network)
	if l > 0 {
...
func (m *ContainerNetworkStatus_IP) Size() (n int) {
	var l int
	_ = l
	l = len(m.IP)
	n += 1 + l + sovTypes(uint64(l))
...
func (m *ContainerNetworkStatus_Error) Size() (n int) {
	var l int
	_ = l
	l = len(m.Error)
	n += 1 + l + sovTypes(uint64(l))
...
func (this *ContainerNetworkStatus) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerNetworkStatus{`,
...
func (this *ContainerNetworkStatus_IP) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerNetworkStatus_IP{`,
		`IP:` + fmt.Sprintf("%v", this.IP) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerNetworkStatus_Error) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerNetworkStatus_Error{`,
...
func (this *ContainerStatus) String() string {
	...
	s := strings.Join([]string{`&ContainerStatus{`,
		...
		`Networks:` + strings.Replace(fmt.Sprintf("%v", this.Networks), "ContainerNetworkStatus", "ContainerNetworkStatus", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ContainerNetworkStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerNetworkStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerNetworkStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.Address = &ContainerNetworkStatus_IP{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Address = &ContainerNetworkStatus_Error{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ContainerStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Networks = append(m.Networks, &ContainerNetworkStatus{})
...
var fileDescriptorTypes = []byte{
	// 4935 bytes of a gzipped FileDescriptorProto
	,
}
