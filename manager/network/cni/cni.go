...
func (nm *cni) Allocator() (networkallocator.NetworkAllocator, error) {
	return cniallocator.New()
}

func (nm *cni) SupportIngressNetwork() bool {
	return false
}
...
func (nm *cni) PredefinedNetworks() []networkallocator.PredefinedNetworkData {
	return nil
}
